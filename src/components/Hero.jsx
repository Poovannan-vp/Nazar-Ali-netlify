      ...
      >
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            >
              {hero.firstName} <span className="gradient-text">{hero.lastName}</span>
            </motion.h1>
            ...
            >
              ...
              <a href="#research" className="btn-secondary">View Research</a>
            </motion.div>
            ...
            >
              <a href={`mailto:${hero.email}`} className="flex items-center gap-2 hover:text-primary-400 transition-colors">
                <HiMail /> {hero.email}
              </a>
              <span className="flex items-center gap-2">
                <HiLocationMarker /> {hero.location}
              </span>
            </motion.div>
            ...
            >
              {hero.social.googleScholar && (
                <a href={hero.social.googleScholar} target="_blank" rel="noopener noreferrer"
              ...
              {hero.social.scopus && (
                <a href={hero.social.scopus} target="_blank" rel="noopener noreferrer"
              ...
              {hero.social.webOfScience && (
                <a href={hero.social.webOfScience} target="_blank" rel="noopener noreferrer"
              ...
              {hero.social.orcid && (
                <a href={hero.social.orcid} target="_blank" rel="noopener noreferrer"
          ...
          <motion.div variants={itemVariants} className="relative">
            <div className="relative mx-auto w-72 h-72 lg:w-80 lg:h-80">
              ...
              <div className="absolute inset-2 rounded-full overflow-hidden border-4 border-dark-200">
                <img src={profileImage} alt={`${hero.firstName} ${hero.lastName}`} className="w-full h-full object-cover" />
              </div>
              ...
              >
                <span className="text-primary-400">{hero.badgeTopRight}</span>
              </motion.div>
              ...
              >
                <span className="text-accent-400">{hero.badgeBottomLeft}</span>
              </motion.div>
            </div>
